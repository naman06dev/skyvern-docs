...
description: Use the Skyvern TypeScript SDK to run, monitor, cancel, and retrieve browser automation tasks with the runTask, getRun, and cancelRun methods.
...
For when to use tasks vs workflows, see [Run a Task](/developers/running-automations/run-a-task).
...
<Tip>
For production, prefer `waitForCompletion: true` or [webhooks](/developers/going-to-production/webhooks) over manual polling.
</Tip>
