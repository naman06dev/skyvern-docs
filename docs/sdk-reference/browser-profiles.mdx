...
description: Save and reuse browser state snapshots using the Skyvern Python SDK. Covers create_browser_profile(), list_browser_profiles(), get_browser_profile(), and delete_browser_profile() for persisting cookies and session data across runs.
