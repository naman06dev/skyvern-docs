...
description: Create, manage, and close persistent browser sessions using the Skyvern Python SDK. Covers create_browser_session(), get_browser_session(), get_browser_sessions(), and close_browser_session() for chaining tasks in a single browser.
