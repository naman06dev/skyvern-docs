...
description: Connect Skyvern to n8n's open-source automation platform. Dispatch tasks and workflows, retrieve results, and integrate browser automations into any n8n workflow.
