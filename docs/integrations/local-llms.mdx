...
description: Configure Skyvern to use local LLMs through Ollama or any OpenAI-compatible endpoint via LiteLLM for self-hosted deployments without cloud LLM dependencies.
