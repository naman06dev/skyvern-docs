...
<CardGroup cols={2}>
  <Card title="Workflow Blocks Reference" icon="cube" href="/developers/multi-step-automations/workflow-blocks-reference">
  ...
  <Card title="File Operations" icon="file" href="/developers/multi-step-automations/file-operations">
