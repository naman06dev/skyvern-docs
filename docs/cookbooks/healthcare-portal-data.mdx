...
description: Extract patient demographics and billing data from OpenEMR using Skyvern workflows with residential proxies, browser profiles, and loop blocks for multi-page pagination.
...
See [Error Handling](/developers/going-to-production/error-handling) and [CAPTCHA & Bot Detection](/developers/going-to-production/captcha-bot-detection) for more.
