...
<Tip>
Set `publish_workflow: true` to save the generated workflow so you can re-trigger it later or [schedule it on a recurring cron](/developers/multi-step-automations/scheduling-workflows).
</Tip>
