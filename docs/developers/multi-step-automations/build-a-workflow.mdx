...
slug: developers/multi-step-automations/build-a-workflow
keywords:
  - create_workflow
  - JSON definition
  - YAML definition
...
<Info>
For detailed documentation on all available block types and their parameters, see [Workflow Blocks Reference](/developers/multi-step-automations/workflow-blocks-reference).
</Info>
...
For the full parameter reference, see [Workflow Parameters](/developers/multi-step-automations/workflow-parameters).
...
<Info>
Skyvern supports 23 block types: navigation, extraction, validation, file download, for loops, conditionals, and more. See [Workflow Blocks Reference](/developers/multi-step-automations/workflow-blocks-reference) for the full list.
</Info>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="cube"
    href="/developers/multi-step-automations/workflow-blocks-reference"
  >
  ...
  <Card
    ...
    icon="sliders"
    href="/developers/multi-step-automations/workflow-parameters"
  >
  ...
  <Card
    ...
    icon="file"
    href="/developers/multi-step-automations/file-operations"
  >
  ...
  <Card
    ...
    icon="calendar"
    href="/developers/multi-step-automations/scheduling-workflows"
  >
