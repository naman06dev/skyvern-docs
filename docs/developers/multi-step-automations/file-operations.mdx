...
description: Download, parse, and upload files in Skyvern workflows using file download, file parser, and upload blocks. Handle PDFs, CSVs, Excel files, and pass files between workflow blocks.
slug: developers/multi-step-automations/file-operations
keywords:
  - file download
  - file upload
  - file parser
...
<Info>
This page uses workflow template syntax (`{{ parameter }}`, `{{ label_output }}`) and assumes familiarity with blocks. See [Build a Workflow](/developers/multi-step-automations/build-a-workflow) for an introduction.
</Info>
...
For the full parameter list, see [File Download](/developers/multi-step-automations/workflow-blocks-reference#file-download) in the blocks reference.
