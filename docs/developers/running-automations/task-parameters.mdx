...
description: Full reference for all task parameters including prompt, URL, engine, data extraction schema, proxy location, browser sessions, TOTP, webhooks, and cost control options.
slug: developers/running-automations/task-parameters
keywords:
  - prompt
  - url
  - engine
...
<CardGroup cols={2}>
  ...
  <Card
    title="Run a Task"
    icon="play"
    href="/developers/running-automations/run-a-task"
  >
