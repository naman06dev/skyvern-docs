...
description: Create and run browser automation tasks using the Skyvern API or SDK. Configure URLs, goals, data extraction schemas, webhooks, and advanced options.
slug: developers/running-automations/run-a-task
keywords:
  - run_task
  - get_run
  - cancel_run
...
For additional parameters like engines, proxies, and extraction schemas, see [Task Parameters](/developers/running-automations/task-parameters).
...
<CardGroup cols={2}>
  <Card
    ...
    icon="sliders"
    href="/developers/running-automations/task-parameters"
  >
  ...
  <Card
    ...
    icon="database"
    href="/developers/running-automations/extract-structured-data"
  >
