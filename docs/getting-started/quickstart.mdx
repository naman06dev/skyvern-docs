...
description: Run your first browser automation task with the Skyvern API. Scrape Hacker News using Python, TypeScript, or cURL in under 5 minutes.
...
2. **Webhooks** — Get notified when the task completes ([see webhooks guide](/developers/going-to-production/webhooks))
