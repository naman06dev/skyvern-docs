...
```json
{
  ...
  "app_url": "https://app.skyvern.com/runs/wr_484019301257171248"
}
```
...
```json
{
  "run_id": "tsk_v2_484019301257171242",
  "status": "completed",
  "recording_url": "https://skyvern-artifacts.s3.amazonaws.com/v1/production/.../recording.webm?AWSAccessKeyId=...&Signature=...&Expires=..."
}
```
