...
```json
{
  "output": {
    "posts": [
      {"title": "Show HN: I built a browser automation tool", "points": 342, "url": "https://..."},
      {"title": "The future of AI agents", "points": 287, "url": "https://..."},
      {"title": "Why Rust is taking over systems programming", "points": 256, "url": "https://..."},
      {"title": "A deep dive into WebAssembly", "points": 198, "url": "https://..."},
      {"title": "How we scaled to 1M users", "points": 176, "url": "https://..."}
    ]
  }
}
```
...
```json
{
  "output": {
    "product": {
      ...
      "availability": {
        "in_stock": true,
        "delivery_estimate": "Tomorrow, Jan 20"
      }
    }
  }
}
...
The extracted data appears in the `output` field of the response.
...
console.log(result.output.points);
```
</CodeGroup>
