...
|-------|------|-------------|
| `run_id` | string | Unique identifier for this run (e.g., `tsk_123`, `tsk_v2_123`) |
| `run_type` | string | Type of run: `task_v1`, `task_v2`, `openai_cua`, `anthropic_cua` |
...
<CardGroup cols={2}>
  ...
  >
    Handle webhook replays and authentication
  </Card>
  <Card
  ...
  >
    Chain multiple tasks together for complex automations
  </Card>
</CardGroup>
